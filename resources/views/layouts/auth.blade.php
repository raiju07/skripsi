...
<body>
    <div class="main-wrapper">
        ...
        <!-- Login box.scss -->
        <!-- ============================================================== -->
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center {{ $bg_color ?? 'bg-dark'}}">
            <div class="auth-box border-top border-secondary {{ $bg_color ?? 'bg-dark'}} {{$border ?? 'border'}}">
                @if (session('status'))
