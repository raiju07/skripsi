        	...
        	<form method="POST" action="{{ url('admin/soal') }}" class="form-horizontal m-t-20" enctype="multipart/form-data" >
        	    ...
        	    <div class="form-row">
        	    	<div class="form-group col-md-6">
        	    	    ...
        	    	    <div id="editor-a" class="quill-editor @error('a') is-invalid @enderror" style="height: 100px;"></div>
	    	    	    @error('a')
	    	                <span class="invalid-feedback" role="alert">
	    	                    <strong>{{ $message }}</strong>
	    	                </span>
        	    	...
        	    	<div class="form-group col-md-6">
        	    	    ...
        	    	    <div id="editor-b"  class="@error('b') is-invalid @enderror" style="height: 100px;"></div>
	    	    	    @error('b')
	    	                <span class="invalid-feedback" role="alert">
	    	                    <strong>{{ $message }}</strong>
	    	                </span>
        	    	...
        	    	<div class="form-group col-md-6">
        	    	    ...
        	    	    <div id="editor-c"  class="@error('c') is-invalid @enderror" style="height: 100px;"></div>
	    	    	    @error('c')
	    	                <span class="invalid-feedback" role="alert">
	    	                    <strong>{{ $message }}</strong>
	    	                </span>
        	    	...
        	    	<div class="form-group col-md-6">
        	    	    ...
        	    	    <div id="editor-d"  class="@error('d') is-invalid @enderror" style="height: 100px;"></div>
	    	    	    @error('d')
	    	                <span class="invalid-feedback" role="alert">
	    	                    <strong>{{ $message }}</strong>
	    	                </span>
