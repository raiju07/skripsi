        	...
        	<form method="post" action="{{ url('admin/soal/'.$soal->id) }}" class="form-horizontal m-t-20" >
        	    ...
        	    <div class="form-row">
        	    	...
        	    	<div class="form-group col-md-6">
        	    	    ...
        	    	    <div id="editor-b"  class="quill-editor @error('b') is-invalid @enderror" style="height: 100px;">{!! old('b', $soal->b) !!}</div>
	    	    	    @error('b')
	    	                <span class="invalid-feedback" role="alert">
	    	                    <strong>{{ $message }}</strong>
	    	                </span>
        	    	...
        	    	<div class="form-group col-md-6">
        	    	    ...
        	    	    <div id="editor-c"  class="quill-editor @error('c') is-invalid @enderror" style="height: 100px;">{!! old('c', $soal->c) !!}</div>
	    	    	    @error('c')
	    	                <span class="invalid-feedback" role="alert">
	    	                    <strong>{{ $message }}</strong>
	    	                </span>
        	    	...
        	    	<div class="form-group col-md-6">
        	    	    ...
        	    	    <div id="editor-d"  class="quill-editor @error('d') is-invalid @enderror" style="height: 100px;">{!! old('d', $soal->d) !!}</div>
	    	    	    @error('d')
	    	                <span class="invalid-feedback" role="alert">
	    	                    <strong>{{ $message }}</strong>
	    	                </span>
