@extends('layouts.app', ['page_title' => 'Admin Baru'  ])
...
<div class="container-fluid bg-white ">
    <div class="row justify-content-center">
        <div class="col-md-12">
        	<form method="POST" action="{{ url('admin/admin') }}" class="form-horizontal m-t-20" id="loginform" enctype="multipart/form-data" >
        	      	@csrf
        	      	<div class="form-row">
        	      		<div class="form-group col text-center">
        	      		    <div class="" style="height:200px">
        	      		        <img id="foto-preview" src="/images/noimage.png" class="img-thumbnail" alt="..." style="height:200px">
        	      		    </div>
        	      	...
        	      	<div class="form-group">
        	      	    <span class="badge badge-warning">Password = password</span>
        	      	</div>
        	      	{{-- <hr>
